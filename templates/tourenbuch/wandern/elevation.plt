...
# -- [ Labels ] --
set label 1 '\textcolor{wandern}{TOP}' at STATS_pos_max_y,STATS_max_y point pointtype 7 ps 0.6 offset 0.3,0.3 front
#set label 2 '\textcolor{wandern}{NNN}' at XXX,YYY point pointtype 7 ps 0.6 offset 0.3,0.3 front
